...
<body>
	...
	<div id="login_bg">
		<div id="login">
			...
			<a href="https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=<?= LINE_LO_CLIENT_ID?>&redirect_uri=<?= urlencode(LINE_LO_CALLBACK."?newflg=0")?>&state=<?= LINE_LO_TOKEN?>&scope=profile&bot_prompt=aggressive" class="lint_btn">
